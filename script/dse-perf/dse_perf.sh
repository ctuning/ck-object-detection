...
##config info
configs=('--dep_add_tags.lib-tensorflow=vcpu' '--dep_add_tags.lib-tensorflow=vcuda --env.CUDA_VISIBLE_DEVICES=-1' '--dep_add_tags.lib-tensorflow=vcuda' '--dep_add_tags.lib-tensorflow=vcuda --env.CK_ENABLE_TENSORRT=1' '--dep_add_tags.lib-tensorflow=vcuda --env.CK_ENABLE_TENSORRT=1 --env.CK_ENABLE_TENSORRT=1')
config_tags=('prebuilt-cpu' 'source-cpu' 'source-cuda' 'tensorRT' 'tensorRT-dynamic')
config_len=${#configs[@]}
